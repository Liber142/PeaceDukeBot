...
constexpr dpp::snowflake GUILD_ID = 1252635272953200650;
constexpr dpp::snowflake CHANNEL_MODERATION_ID = 1271535210537680897; // ID канала модерации
constexpr dpp::snowflake MEMBER_ROLE_ID = 1253074402346795078; // Исправлено на существующую роль
constexpr dpp::snowflake CLAN_ROLE_ID = 1253074402346795078; // ID роли клана
constexpr dpp::snowflake DEFAULT_ROLE_ID = 1252679487968120852;
constexpr dpp::snowflake GENERAL_ROLE_ID = 1298109770355576946;
constexpr dpp::snowflake MODERATOR_ROLE_ID = 1253074402346795078;

constexpr dpp::snowflake WELCOME_CHANNEL_ID = 1270600965749473371;
constexpr dpp::snowflake CHANNEL_ONLINE_MEMBERS_ID = 1387967027892981770;
