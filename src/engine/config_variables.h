...
"Надеюсь, Вы еще найдете место по душе!!🫶", CFGFLAG_SAVE, "DM sent when an application is rejected");
...
"\t⚜‽Ð⚜\n"
"Выбирай любой!\n"
"Вливайся в общество и еще раз Добро пожаловать!🥳🎉", CFGFLAG_SAVE, "DM sent when an application is approved");
